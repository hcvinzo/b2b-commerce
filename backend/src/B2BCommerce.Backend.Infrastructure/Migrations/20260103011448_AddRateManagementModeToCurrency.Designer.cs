...
namespace B2BCommerce.Backend.Infrastructure.Migrations
{
    ...
    [Migration("20260103011448_AddRateManagementModeToCurrency")]
    partial class AddRateManagementModeToCurrency
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("B2BCommerce.Backend.Domain.Entities.Campaign", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("B2BCommerce.Backend.Domain.Entities.CampaignUsage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("B2BCommerce.Backend.Domain.Entities.Currency", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("RateManagementMode")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("B2BCommerce.Backend.Domain.Entities.DiscountRule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("CustomerTargetType")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("ProductTargetType")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("CustomerTargetType");

                    b.HasIndex("DiscountType");

                    b.HasIndex("IsDeleted");

                    b.HasIndex("ProductTargetType");

                    b.ToTable("DiscountRules", (string)null);
                });

            modelBuilder.Entity("B2BCommerce.Backend.Domain.Entities.DiscountRuleBrand", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("DiscountRuleId", "BrandId")
                        .IsUnique()
                        .HasFilter("\"IsDeleted\" = false");

                    b.ToTable("DiscountRuleBrands", (string)null);
                });

            modelBuilder.Entity("B2BCommerce.Backend.Domain.Entities.DiscountRuleCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("DiscountRuleId", "CategoryId")
                        .IsUnique()
                        .HasFilter("\"IsDeleted\" = false");

                    b.ToTable("DiscountRuleCategories", (string)null);
                });

            modelBuilder.Entity("B2BCommerce.Backend.Domain.Entities.DiscountRuleCustomer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("DiscountRuleId", "CustomerId")
                        .IsUnique()
                        .HasFilter("\"IsDeleted\" = false");

                    b.ToTable("DiscountRuleCustomers", (string)null);
                });

            modelBuilder.Entity("B2BCommerce.Backend.Domain.Entities.DiscountRuleCustomerTier", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("PriceTier");

                    b.HasIndex("DiscountRuleId", "PriceTier")
                        .IsUnique()
                        .HasFilter("\"IsDeleted\" = false");

                    b.ToTable("DiscountRuleCustomerTiers", (string)null);
                });

            modelBuilder.Entity("B2BCommerce.Backend.Domain.Entities.DiscountRuleProduct", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("DiscountRuleId", "ProductId")
                        .IsUnique()
                        .HasFilter("\"IsDeleted\" = false");

                    b.ToTable("DiscountRuleProducts", (string)null);
                });
            ...
            modelBuilder.Entity("B2BCommerce.Backend.Domain.Entities.Campaign", b =>
                {
                    b.OwnsOne("B2BCommerce.Backend.Domain.ValueObjects.Money", "PerCustomerBudgetLimit", b1 =>
                        {
                    ...
                    b.OwnsOne("B2BCommerce.Backend.Domain.ValueObjects.Money", "TotalBudgetLimit", b1 =>
                        {
                            b1.Property<Guid>("CampaignId")
                                .HasColumnType("uuid");
                    ...
                    b.OwnsOne("B2BCommerce.Backend.Domain.ValueObjects.Money", "TotalDiscountUsed", b1 =>
                        {
                            b1.Property<Guid>("CampaignId")
                                .HasColumnType("uuid");
                    ...
                    b.Navigation("PerCustomerBudgetLimit");

                    b.Navigation("TotalBudgetLimit");

                    b.Navigation("TotalDiscountUsed")
                        .IsRequired();
                });

            modelBuilder.Entity("B2BCommerce.Backend.Domain.Entities.CampaignUsage", b =>
                {
                    b.HasOne("B2BCommerce.Backend.Domain.Entities.Campaign", "Campaign")
                        .WithMany("Usages")
                        .HasForeignKey("CampaignId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.HasOne("B2BCommerce.Backend.Domain.Entities.OrderItem", "OrderItem")
                        .WithMany()
                    ...
                    b.OwnsOne("B2BCommerce.Backend.Domain.ValueObjects.Money", "DiscountAmount", b1 =>
                        {
                            b1.Property<Guid>("CampaignUsageId")
                                .HasColumnType("uuid");
                            ...
                            b1.HasKey("CampaignUsageId");

                            b1.ToTable("CampaignUsages");
            ...
            modelBuilder.Entity("B2BCommerce.Backend.Domain.Entities.DiscountRuleBrand", b =>
                {
                    ...
                    b.HasOne("B2BCommerce.Backend.Domain.Entities.DiscountRule", "DiscountRule")
                        .WithMany("Brands")
