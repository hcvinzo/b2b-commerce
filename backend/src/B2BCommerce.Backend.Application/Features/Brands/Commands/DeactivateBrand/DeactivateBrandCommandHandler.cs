...
/// </summary>
public class DeactivateBrandCommandHandler : ICommandHandler<DeactivateBrandCommand, Result<BrandDto>>
{
    private readonly IUnitOfWork _unitOfWork;

    public DeactivateBrandCommandHandler(IUnitOfWork unitOfWork)
    {
        _unitOfWork = unitOfWork;
    }

    public async Task<Result<BrandDto>> Handle(DeactivateBrandCommand request, CancellationToken cancellationToken)
    {
