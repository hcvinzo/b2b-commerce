...
/// </summary>
public class GetAllOrdersQueryHandler : IQueryHandler<GetAllOrdersQuery, Result<PagedResult<OrderDto>>>
{
    ...
    {
        return await _orderService.GetAllAsync(request.PageNumber, request.PageSize, cancellationToken);
    }
}
